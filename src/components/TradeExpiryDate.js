...
const TradeExpiryDate = ({ disabled, onChange }) => {
    ...
    return (
        <DatePicker
            showIcon
            selected={startDate}
            onChange={handleDateChange}  // Use the renamed function
            disabled={disabled}
            includeDates={includeDates}
            placeholderText="Set Expiry Date"
        />
    );
}

export default TradeExpiryDate;